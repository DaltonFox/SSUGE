...
{
	// Note: we could probably optimize this by hooking into Ogre's Node::Listener interface and only
	// doing this when the position changes, rather than every frame.
	if (mSound)
	{
