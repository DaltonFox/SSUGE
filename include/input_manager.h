...
namespace ssuge
{
	...
	public:
		...
		public:
			...
			virtual void onTouch(unsigned int device, float x, float y, float xrel, float yrel) {}
		};
	...
	public:
		...
		/// Sets the visibility of the system mouse
	...
	protected:
		...
		void broadcastTouch(unsigned int touch_num, float x, float y, float xrel, float yrel);
	};
}
